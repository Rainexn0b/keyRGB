...
```bash
curl -fsSL https://raw.githubusercontent.com/Rainexn0b/keyRGB/v0.35.0/install.sh -o install.sh && bash install.sh
```
...
| `--version <tag>` | Install a specific tag such as `v0.35.0`. |
