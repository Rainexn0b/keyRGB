...
from keyrgb.core.profile._backdrop import BACKDROP_MODE_CUSTOM, BACKDROP_MODE_NONE, normalize_backdrop_mode
from keyrgb.core.resources.layout import BASE_IMAGE_SIZE
from keyrgb.gui.utils.backdrop_image_cache import backdrop_image_candidates, load_cached_backdrop_image
