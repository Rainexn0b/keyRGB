...
from keyrgb.gui.perkey.hardware import NUM_COLS, NUM_ROWS
from keyrgb.gui.perkey.ui._profile_actions_support import (
...
def _facade():
    ...
    from keyrgb.gui.perkey.ui import profile_actions as facade
