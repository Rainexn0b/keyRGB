...
def get_default_keymap(layout_id: str):
    from keyrgb.core.resources.defaults import get_default_keymap as _get_default_keymap

    return _get_default_keymap(layout_id)


def get_default_layout_tweaks(layout_id: str):
    from keyrgb.core.resources.defaults import get_default_layout_tweaks as _get_default_layout_tweaks

    return _get_default_layout_tweaks(layout_id)


def get_default_per_key_tweaks(layout_id: str):
    from keyrgb.core.resources.defaults import get_default_per_key_tweaks as _get_default_per_key_tweaks

    return _get_default_per_key_tweaks(layout_id)


def get_layout_keys(*args, **kwargs):
    from keyrgb.core.resources.layouts import get_layout_keys as _get_layout_keys

    return _get_layout_keys(*args, **kwargs)


def resolve_layout_id(*args, **kwargs):
    from keyrgb.core.resources.layouts import resolve_layout_id as _resolve_layout_id
