...
from keyrgb.core.resources.layouts.catalog import VALID_LAYOUT_IDS
from keyrgb.gui.settings import _settings_reader as settings_reader, _settings_scheduler as settings_scheduler
...
class SettingsValues:
    ...
    # Canonical values come from keyrgb.core.resources.layouts.catalog.
