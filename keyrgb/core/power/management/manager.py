...
from keyrgb.core.profile import profiles as perkey_profiles, runtime_activation as profile_runtime_activation
...
class PowerManager:
    ...
    def __init__(self, keyboard_controller, *, config: Config | None = None):
        ...
        from keyrgb.core.config import Config as _Config
