...
from keyrgb.core.effects.engine_support import _EngineBrightness, _EngineCore, _EngineStart
...
class EffectsEngine(_EngineCore, _EngineBrightness, _EngineStart):
    ...
    # Canonical effect lists are defined in keyrgb.core.effects.catalog.
