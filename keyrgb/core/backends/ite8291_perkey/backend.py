...
import keyrgb.core.backends.base as _backend_base
import keyrgb.core.backends.exceptions as _backend_errors
from keyrgb.core.utils import exceptions as _exception_utils
...
class Ite8291Backend(_backend_base.KeyboardBackend):
    ...
    def get_device(self) -> _backend_base.KeyboardDevice:
        ...
        try:
            ...
            return Ite8291KeyboardDevice(
                transport.send_feature_report, transport.write_output_report, transport=transport
            )
