...
from keyrgb.core.profile.json_storage import read_json, update_json_atomic
from keyrgb.core.resources.layout import resolve_physical_layout
from keyrgb.core.resources.layout_slots import get_layout_slot_key_ids, sanitize_layout_slot_overrides
...
def _load_prior_profile_slot_overrides(
    ...
    *,
    ...
    from keyrgb.core.profile.paths import safe_profile_name
