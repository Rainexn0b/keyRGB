...
from keyrgb.core.resources.layout_legends import apply_layout_legend_pack, clear_layout_legend_cache
from keyrgb.core.resources.layout_slots import apply_layout_slot_overrides, sanitize_layout_slot_overrides
...
def get_layout_keys(
    ...
    *,
    ...
    :func:`keyrgb.core.resources.layout.build_layout`.
    """
