...
from keyrgb.core.utils.safe_attrs import safe_int_attr, safe_str_attr
...
from keyrgb.tray.pollers.idle_power._restore_policy import classify_idle_restore_start
...
def restore_from_idle(tray: IdlePowerTrayProtocol) -> None:
    ...
    from keyrgb.tray.pollers.idle_power._transition_actions import (
...
def apply_idle_action(
    ...
    *,
    ...
    from keyrgb.tray.pollers.idle_power._action_execution import execute_idle_action
