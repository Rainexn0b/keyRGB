...
def _set_idle_state_field(
    ...
    *,
    ...
    idle_power_state.set_idle_power_state_field(tray, attr_name=prior_name, state_name=state_name, value=value)


def _sync_idle_state_field(tray: IdlePowerTrayProtocol, *, prior_name: str, state_name: str) -> object:
    return idle_power_state.sync_idle_power_state_field(tray, attr_name=prior_name, state_name=state_name)
