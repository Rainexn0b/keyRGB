...
from keyrgb.core.backends.base import BackendStability
from keyrgb.core.backends.ite8910_perkey import Ite8910Backend, Ite8910KeyboardDevice
from keyrgb.core.backends.ite8910_perkey.protocol import (
    KNOWN_LED_IDS,
    Ite8910Effect,
...
def test_backend_get_device_returns_keyboard(
    ...
    monkeypatch.setattr(
        "keyrgb.core.backends.ite8910_perkey.backend.open_matching_hidraw_transport",
...
def test_backend_probe_reports_available_when_device_present(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "keyrgb.core.backends.ite8910_perkey.backend.find_matching_hidraw_device",
