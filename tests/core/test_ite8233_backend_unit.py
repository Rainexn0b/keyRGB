...
from src.core.backends.ite8233.backend import Ite8233Backend, _find_matching_supported_hidraw_device, _open_matching_transport
...
def test_ite8233_probe_reports_detected_device_but_requires_opt_in(
...
def test_ite8233_probe_reports_available_when_opted_in(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("src.core.backends.ite8233.backend._find_matching_supported_hidraw_device", lambda: DummyMatch())
...
def test_ite8233_get_device_wraps_permission_error(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("src.core.backends.ite8233.backend._open_matching_transport", lambda: (_ for _ in ()).throw(err))
