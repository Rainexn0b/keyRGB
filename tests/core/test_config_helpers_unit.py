...
from src.core.config._coercion import (
    _clamp_rgb_channel,
    coerce_loaded_settings,
    normalize_brightness_value,
    normalize_rgb_triplet,
)
from src.core.config._props import bool_prop, enum_prop, int_prop, optional_brightness_prop
...
def test_optional_brightness_prop_handles_getter_failure_and_none_setter() -> None:
    class Holder:
