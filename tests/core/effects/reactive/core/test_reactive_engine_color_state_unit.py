...
class TestGetEngineManualReactiveColor:
    def test_returns_none_when_flag_false(self):
        from keyrgb.core.effects.reactive._engine_color_state import get_engine_manual_reactive_color
...
class TestGetEngineReactiveColor:
    def test_returns_manual_when_available(self):
        from keyrgb.core.effects.reactive._engine_color_state import get_engine_reactive_color
