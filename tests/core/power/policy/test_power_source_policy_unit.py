...
from keyrgb.core.power.policies.power_source_policy import compute_power_source_policy
...
def test_policy_accepts_float_override_values() -> None:
    enabled, brightness = compute_power_source_policy(
        on_ac=False,
        ac_enabled=True,
        battery_enabled=True,
...
def test_policy_ignores_non_finite_or_non_numeric_override() -> None:
    enabled, brightness = compute_power_source_policy(
        on_ac=True,
        ac_enabled=True,
        battery_enabled=True,
        ac_brightness_override="inf",
        battery_brightness_override=None,
    )
    assert enabled is True
    assert brightness is None
    ...
    enabled, brightness = compute_power_source_policy(
        ...
        ac_enabled=True,
        battery_enabled=True,
        ac_brightness_override=float("inf"),
        battery_brightness_override=None,
    )
    assert enabled is True
    assert brightness is None
