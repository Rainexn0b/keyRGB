...
def test_resize_edges_for_point_in_bbox_detects_edges_and_corners(point: tuple[float, float], expected: str) -> None:
    cx, cy = point
...
def test_resize_edges_for_point_in_bbox_honors_threshold_boundaries(point: tuple[float, float], expected: str) -> None:
    cx, cy = point
