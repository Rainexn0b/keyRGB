...
class _FakeSelf:
    def __init__(self, editor) -> None:
        ...
        self.refresh_legend_pack_choices = layout_setup.LayoutSetupControls.refresh_legend_pack_choices.__get__(self, _FakeSelf)
...
def test_build_ui_creates_layout_controls_and_refreshes_slots(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(layout_setup, "_legend_pack_choices", lambda _layout_id: [("auto", "Default legends"), ("ansi-generic", "ANSI Generic")])
