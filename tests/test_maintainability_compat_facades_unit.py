...
def test_lighting_mode_compatibility_facade() -> None:
    from keyrgb.tray.controllers import _lighting_controller_helpers as facade, _lighting_mode_apply as owner
...
def test_hardware_recovery_compatibility_facade() -> None:
    from keyrgb.tray.pollers import hardware_polling as facade
    from keyrgb.tray.pollers.hardware import _recovery as owner
...
def test_reactive_brightness_compatibility_facade() -> None:
    from keyrgb.core.effects.reactive import (
...
def test_profile_action_compatibility_facade() -> None:
    from keyrgb.gui.perkey.ui import _profile_actions_ui as owner, profile_actions as facade
...
def test_power_manager_poll_interval_monkeypatch_seam() -> None:
    from keyrgb.core.power.management import _manager_battery_saver as owner, manager as facade
