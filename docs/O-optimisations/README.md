# O-optimisations — Performance and stability

**Scope:** Performance, stability, RAM footprint, and reactive-effect
optimisation plans.
...
- `docs/1-src/08-reactive-brightness-invariants.md` — reactive brightness
  invariants
