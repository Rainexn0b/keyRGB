...
This note anchors the current package-boundary and GUI-boundary refactor campaign. It complements the active roadmap in [architecture-and-maintainability-improvement-plan.md](architecture-and-maintainability-improvement-plan.md) and the earlier package-layout assessment in [archived/2026-04-17/package-structure-assessment.md](../2026-04-17/package-structure-assessment.md).
