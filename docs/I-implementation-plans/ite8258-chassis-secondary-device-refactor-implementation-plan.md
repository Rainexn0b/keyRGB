...
**File:** `src/core/backends/ite8258_perkey_chassis/protocol.py`
...
**File:** `src/core/backends/ite8258_perkey_chassis/device.py`
...
**File:** `src/core/backends/ite8258_perkey_chassis/backend.py`
