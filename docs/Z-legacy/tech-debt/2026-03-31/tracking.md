...
| 4 | Backends / architecture | Extract a shared USB backend layer for probe, capability, and permission patterns. See [backend-shared-usb-layer.md](backend-shared-usb-layer.md). | P1 | M | File Size, LOC Check, Architecture Validation | monitoring |
...
- **Active paydown plan (2026-07-15):** see
  [`docs/I-implementation-plans/2026-07-15/maintainability-debt-paydown-plan.md`](../../I-implementation-plans/2026-07-15/maintainability-debt-paydown-plan.md)
  for the current inventory (D1–D12), phases, and progress log. Prefer that doc
  for "what next"; keep this folder for historical detail.