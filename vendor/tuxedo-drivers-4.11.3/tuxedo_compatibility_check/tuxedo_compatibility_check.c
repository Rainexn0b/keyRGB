...
static bool force_compatible;
module_param(force_compatible, bool, 0644);
MODULE_PARM_DESC(force_compatible,
		 "Force compatibility check to pass regardless of DMI/CPU checks");
