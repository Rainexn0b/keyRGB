...
# -----------------------------------------------------------------------------
# Legacy monolithic installer (deprecated)
# -----------------------------------------------------------------------------
...
install_icon_and_desktop_entries() {
    ...
    if [ "$MODE" = "pip" ]; then
        local icon_src="$REPO_DIR/assets/logo-keyrgb.svg"
        if ! [ -f "$icon_src" ]; then
        ...
        local icon_url="https://raw.githubusercontent.com/Rainexn0b/keyRGB/$raw_ref/assets/logo-keyrgb.svg"
