...
def env_snapshot() -> dict[str, str]:
    env_keys = [
        ...
        "KEYRGB_ITE8291_ZONES_REPORT_DELAY_MS",
        "KEYRGB_ITE8291R3_REPORT_DELAY_MS",
        "KEYRGB_ITE8295_ZONES_REPORT_DELAY_MS",
        "KEYRGB_ITE8910_REPORT_DELAY_MS",
        "KEYRGB_ITE8233_REPORT_DELAY_MS",
        "KEYRGB_ITE8297_REPORT_DELAY_MS",
        "KEYRGB_ITE8258_REPORT_DELAY_MS",
        "KEYRGB_ITE8258_CHASSIS_REPORT_DELAY_MS",
        "XDG_CURRENT_DESKTOP",
        "DESKTOP_SESSION",
    ]
    env: dict[str, str] = {}
