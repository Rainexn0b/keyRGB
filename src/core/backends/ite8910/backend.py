...
class Ite8910Backend(KeyboardBackend):
    ...
    def effects(self) -> dict[str, Any]:
        return {
            "rainbow": make_hardware_effect_descriptor(
                _effect_builder("rainbow_wave"),
                supported_args=("speed", "brightness"),
            ),
            "breathing": make_hardware_effect_descriptor(
                _effect_builder("breathing_color", extra=("color",)),
                supported_args=("speed", "brightness", "color"),
            ),
            "wave": make_hardware_effect_descriptor(
                _effect_builder("rainbow_wave", extra=("direction", "color")),
                supported_args=("speed", "brightness", "direction", "color"),
            ),
            "scan": make_hardware_effect_descriptor(
                _effect_builder("scan", extra=("color",)),
                supported_args=("speed", "brightness", "color"),
            ),
            "flashing": make_hardware_effect_descriptor(
                _effect_builder("flashing_color", extra=("color",)),
                supported_args=("speed", "brightness", "color"),
            ),
            "random": make_hardware_effect_descriptor(
                _effect_builder("random_color", extra=("color",)),
                supported_args=("speed", "brightness", "color"),
            ),
            "snake": make_hardware_effect_descriptor(
                _effect_builder("snake", extra=("direction", "color")),
                supported_args=("speed", "brightness", "direction", "color"),
            ),
            "spectrum_cycle": make_hardware_effect_descriptor(
                _effect_builder("spectrum_cycle"),
                supported_args=("speed", "brightness"),
            ),
        }
