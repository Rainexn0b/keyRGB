...
def update_custom_profile(
    ...
    *,
    ...
    try:
        ...
        unlink_tmp(tmp, key="tcc_profiles.update_custom_profile.cleanup")
...
def create_custom_profile(
    ...
    *,
    ...
    try:
        ...
        unlink_tmp(tmp, key="tcc_profiles.create_custom_profile.cleanup")
...
def duplicate_custom_profile(
    ...
    *,
    ...
    try:
        ...
        unlink_tmp(tmp, key="tcc_profiles.duplicate_custom_profile.cleanup")
...
def rename_custom_profile(
    ...
    *,
    ...
    try:
        ...
        unlink_tmp(tmp, key="tcc_profiles.rename_custom_profile.cleanup")
    ...
    *,
    ...
    try:
        ...
        for p in [tmp_profiles, tmp_settings]:
            if p:
                unlink_tmp(p, key="tcc_profiles.delete_custom_profile.cleanup")
